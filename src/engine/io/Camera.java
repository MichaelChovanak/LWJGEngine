...
public class Camera {
	...
	private Matrix4f invViewProjectionMatrix = new Matrix4f();
	 ...
	 * 
	 * @param frustumNear
	 *            the distance of the near frustum plane
	 */
	 ...
	 * 
	 * @param frustumFar
	 *            the distance of the far frustum plane
	 */
	 ...
	 * 
	 * @param frustumLeft
	 *            the distance of the left frustum plane
	 */
	 ...
	 * 
	 * @param frustumRight
	 *            the distance of the right frustum plane
	 */
	 ...
	 * 
	 * @param frustumTop
	 *            the distance of the top frustum plane
	 */
	 ...
	 * 
	 * @param frustumBottom
	 *            the distance of the bottom frustum plane
	 */
	...
	private Vector3f permUp = new Vector3f(0,1,0);
	
	public Vector3f getPermUp() {
		return permUp;
	}
